...
public class EarthquakeProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI =
            Uri.parse("content://com.plagueis.labs.earthquakeprovider/earthquakes");
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        // If no sort is specified, sort by date / time
        String orderBy;
        ...
        // Register the context ContentResolver to be notified if
    ...
    public Uri insert(Uri _uri, ContentValues values) {
        ...
        // Return a URI t the newly inserted row on success.
        if(rowID > 0){
    ...
    private static final class EarthquakeDatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXIST " + EARTHQUAKE_TABLE);
            onCreate(db);
        }
    }
}
